<main class="container pb-5">
  <div class="row row-cols-1 row-cols-md-2 g-4 justify-content-center">
    ...
    <div class="col">
        <a href="?pg=JOASLUNA/enter/entrar&tipo-de-conta=Admin" class="text-decoration-none">
    ...
    <div class="col">
        <a href="?pg=JOASLUNA/enter/entrar&tipo-de-conta=ComomUser" class="text-decoration-none">
            <div class="card h-100 text-center p-4 shadow-sm">
