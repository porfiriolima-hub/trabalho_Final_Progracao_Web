...
(9, 'Dell memória atualização - 4 Go - 1Rx16 DDR4 SODIMM 3200 MT/s', 439.00, 16, 'Componente de Informática ', 'A memória de acesso aleatório (RAM) é um tipo de hardware que seu computador usa para armazenar informações. Adicionar memória é uma das maneiras mais econômicas de melhorar a performance do seu computador.');
